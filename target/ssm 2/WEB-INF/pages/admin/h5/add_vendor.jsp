...
//------------------------logo  end---------------------------------
            ...
            $("#login_button").click(function () {
                ...
                var imgs=$("#imgs").val();
                alert(imgs_logo);
                var mdata = 'imgs='+imgs+'&imgs_logo='+imgs_logo+'&name=' + name + '&address=' + address + '&address_point_x=' + address_point_x + '&address_point_y=' + address_point_y + '&logo=' + logo + '&sale_percapitaprice=' + sale_percapitaprice + '&sale_cookingstyle=' + sale_cookingstyle + '&business_hours=' + business_hours + ''
                //alert(1);
